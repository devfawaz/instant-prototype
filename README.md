...
> **Disclaimer:** This is an independent, unofficial design exercise based on a take-home interview challenge from Instant. It is not affiliated with, endorsed by or representative of Instant. The Instant name and logo are used for illustrative, non-commercial portfolio purposes only; NovaMart is a fictional store, and all figures are illustrative.
